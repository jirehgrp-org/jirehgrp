...
export const NavItems = ({ items, className, onItemClick }: NavItemsProps) => {
  ...
  return (
    <motion.div
      ...
      className={cn(
        "hidden lg:flex flex-row items-center justify-center flex-grow gap-6 text-sm font-medium text-zinc-600 dark:text-zinc-300",
        className
      )}
    >
      {items.map((item, idx) => (
        ...
        >
          {hovered === idx && (
            <motion.div
              layoutId="hovered"
              className="hidden lg:flex items-center justify-center flex-grow gap-6 text-sm font-medium text-zinc-600 dark:text-zinc-300"
            />
          )}
  ...
  return (
    ...
    >
      <Image
        ...
        height={30}
      />
      <span className="font-medium text-black dark:text-white">JirehGroup</span>
    </a>
  );
};
...
export const NavbarButton = ({
  ...
  // Actual return block with conditional rendering
  if (Tag === "a") {
